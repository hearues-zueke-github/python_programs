...
void test_own_determination() {
  vector<vector<i64>> A_1 = {
    ...
    i64 det_A_1 = 3490;
    // cout << "det_A_1: " << det_A_1 << endl;

    i64 det_A_1_calc = detMatInt(A_1);
    // cout << "det_A_1_calc: " << det_A_1_calc << endl;
    ...
    i64 det_A_2 = 2552976;
    // cout << "det_A_2: " << det_A_2 << endl;

    i64 det_A_2_calc = detMatInt(A_2);
    // cout << "det_A_2_calc: " << det_A_2_calc << endl;
...
int main(int argc, char* argv[]) {
  ...
  cout << "A11_12: " << A11_12 << endl;

  Matrix A11_12_ref = Matrix({{7, 10, 0}, {15, 22, 4}, {19, 28, 6}});
  assert(A11_12 == A11_12_ref);

  // cout << "A11_12==A11_12_ref: " << (A11_12==A11_12_ref) << endl;

  // TODO: implement equal operator and unequal operator!
