SELECT
	factor_amount, modulo, cycle_len, factor_len, amount_nonzero_factors, COUNT(amount_nonzero_factors) count_amount_nonzero_factors
FROM
...
GROUP BY
	factor_amount, modulo, cycle_len, factor_len, amount_nonzero_factors
ORDER BY
	factor_amount, modulo, cycle_len, factor_len, amount_nonzero_factors
;

SELECT
	factor_amount, modulo, factor_len, cycle_len, COUNT(factor_len) count_factor_len
FROM
	cyclic_n_factor_sequence
-- WHERE
-- 	factor_len = 9 AND
